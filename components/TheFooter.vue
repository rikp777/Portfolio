    ...
    <div class="max-w-7xl border-l border-r border-dashed border-gray-700 mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        <div class="flex space-x-6 md:order-2">
          <a v-if="$config.social.lastfm" target="_blank" rel="noreferrer"  :href="`https://www.last.fm/user/${$config.social.lastfm}`" class="text-gray-400 hover:text-gray-300">
            <span class="sr-only">Lastfm</span>
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1">
         <span class="ceator-preview hover:text-hot-pink text-gray-300">
          <a class="hidden md:inline-block" rel="noreferrer" target="_blank" href="#">
          <creator-preview
            :avatar="avatar"
            :name="name"
...
export default {
  ...
  data() {
    return {
      ...
      mode: 'dark',
      description: 'Hey, I am Rik Peeters 👋',
      content: `Fulltime student at Fontys university studying Software Engineer and cyber security`,
    }
  }
}
</script>
